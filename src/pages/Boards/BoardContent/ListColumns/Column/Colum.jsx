...
function Colum() {
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        height: (theme) => theme.trello.columnHeader,
        p: 2,
        display: 'flex',
        alignItems: 'center',
        ...
        <Box>
          <Tooltip title='More options'>
            <ExpandMoreIcon
              ...
              id="basic-button-dropdowns"
              aria-controls={open ? 'basic-menu-dropdowns' : undefined}
              aria-haspopup="true"
          ...
          <Menu
            id="basic-menu-dropdowns"
            anchorEl={anchorEl}
            open={open}
            onClose={handleClose}
            slotProps={{
              list: {
                'aria-labelledby': 'basic-button-dropdowns'
              }
            }}
          >
            <MenuItem>
      ...
      {/* FOOTER */}
      <Box sx={{
        height: (theme) => theme.trello.columnFooter,
        p: 2,
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'space-between'
